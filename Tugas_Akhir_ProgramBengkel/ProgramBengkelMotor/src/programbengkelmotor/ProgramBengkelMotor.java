...
public class ProgramBengkelMotor {
    ...
    static void showMenu() {
        ...
        System.out.println("| 5. Cetak Setruk                     |");
    ...
    while (isAdding) {
        ...
        System.out.println("|        Pilihan Jenis Layanan Lainnya       |");
    ...
    if (dataList.isEmpty()) {
        ...
        while (isViewing) {
            ...
            System.out.printf("\nHalaman %d:\n", page + 1);
            System.out.println("=============================================================================================================================================================================");
            System.out.println("| No |       Nama        |    No Telepon    |   Tanggal   |   Jenis Motor   | Jenis Layanan |     Biaya     |       Layanan Lainnya       |     Biaya     |     Total     |");
            System.out.println("|----|-------------------|------------------|-------------|-----------------|---------------|---------------|------------------------------|----------------|---------------|");

            for (int i = page * 3; i < Math.min((page + 1) *3 , dataList.size()); i++) {
                DataBengkel data = dataList.get(i);
                total = data.biaya + data.biayaTambahan;
                System.out.printf("| %-2d | %-17.17s | %-16s | %-11s | %-15s | %-13s |Rp.%-12d| %-27s |Rp.%-12d|Rp.%-12d|\n", 
    ...
    if (dataList.isEmpty()) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            System.out.printf("%d. %s \n", i + 1, dataList.get(i).namaPelanggan);
        }

        System.out.print("Masukkan nomor pelanggan yang ingin dicetak struknya: ");
        int pilihan = scanner.nextInt();
        scanner.nextLine(); // Buang newline

        if (pilihan > 0 && pilihan <= dataList.size()) {
            DataBengkel data = dataList.get(pilihan - 1);
            int total = data.biaya + data.biayaTambahan;
            ...
            System.out.printf("| %-20s : %-50s |\n", "Tanggal Pelayanan", data.tanggalPelayanan);
            System.out.printf("| %-20s : %-50s |\n", "Jenis Motor", data.jenisMotor);
            System.out.printf("| %-20s : %-30s        %12d |\n", "Jenis Layanan", data.jenisLayanan,data.biaya);
            System.out.printf("| %-20s   %-30s        %12d |\n", "", data.tambahanLayanan,data.biayaTambahan);
            System.out.println("=============================================================================");
